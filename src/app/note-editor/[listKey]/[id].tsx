  ...
  return (
    ...
    >
      ...
      <TextInput
        ...
        placeholderTextColor={theme.muted2}
        multiline
        style={[styles.textArea, { color: theme.text, fontSize: sizes.editorBody, lineHeight: sizes.editorBody * 1.53 }]}
      />
    </KeyboardAvoidingView>
  );
}
...
const styles = StyleSheet.create({
  ...
  textArea: { flex: 1, paddingHorizontal: 20, paddingTop: 4, textAlignVertical: 'top' },
});
